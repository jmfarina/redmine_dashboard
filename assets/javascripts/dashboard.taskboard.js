	...
	*/
	...
	Rdb.rdbInitDAD = function () {
		...
		el.find(".rdb-column").each(function() {
            ...
            if(cgroup.startsWith('assigne_') || cgroup.startsWith('assignee-') || cgroup.startsWith('version-') || cgroup.startsWith('version_'))
            ...
            } else if(cgroup.startsWith('assignee-')) {
              assignTarget = cgroup.slice(9);
            }
